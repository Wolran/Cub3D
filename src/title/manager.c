...
/*   Updated: 2023/11/07 15:58:34 by vmuller          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_v2i const center = {eng->sel_spr->size[0] / 2, eng->sel_spr->size[1] / 2 + eng->sel_spr->size[1] / 3};

	if (title->time > 0.0f)
	{
		ft_put_text(eng, (t_v2i){center[0] - ft_strlen(title->str) / 2 * 7, center[1]}, title->str, 1);
